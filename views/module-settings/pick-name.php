...
<div class="forminator-integration-popup__header">
	<h3 id="forminator-integration-popup__title" class="sui-box-title sui-lg" style="overflow: initial; white-space: normal; text-overflow: initial;"><?php esc_html_e( 'Set up a name', 'real-estate-leads-for-forminator' ); ?></h3>
	<p id="forminator-integration-popup__description" class="sui-description"><?php esc_html_e( 'Give this connection a friendly name so you can identify it.', 'real-estate-leads-for-forminator' ); ?></p>
...
<form>
	<div class="sui-form-field <?php echo esc_attr( ! empty( $ffub_vars['name_error'] ) ? 'sui-form-field-error' : '' ); ?>">
		<label class="sui-label"><?php esc_html_e( 'Name', 'real-estate-leads-for-forminator' ); ?></label>
		<input class="sui-form-control" name="name" value="<?php echo esc_attr( $ffub_vars['name'] ); ?>"
			placeholder="<?php esc_attr_e( 'Friendly name', 'real-estate-leads-for-forminator' ); ?>">
