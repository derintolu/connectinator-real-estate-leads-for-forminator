...
<div class="forminator-integration-popup__header">
	<h3 id="forminator-integration-popup__title" class="sui-box-title sui-lg" style="overflow: initial; white-space: normal; text-overflow: initial;">
		<?php esc_html_e( 'Connect Follow Up Boss', 'real-estate-leads-for-forminator' ); ?>
	</h3>
	<p id="forminator-integration-popup__description" class="sui-description">
		<?php esc_html_e( 'Enter your Follow Up Boss API key (Follow Up Boss → Admin → API).', 'real-estate-leads-for-forminator' ); ?>
	</p>
...
<form>
	<div class="sui-form-field<?php echo esc_attr( ! empty( $ffub_vars['api_key_error'] ) ? ' sui-form-field-error' : '' ); ?>">
		<label class="sui-label"><?php esc_html_e( 'API Key', 'real-estate-leads-for-forminator' ); ?></label>
		<div class="sui-control-with-icon">
			<input name="api_key" value="<?php echo esc_attr( $ffub_vars['api_key'] ); ?>"
				placeholder="<?php esc_attr_e( 'Enter your Follow Up Boss API key', 'real-estate-leads-for-forminator' ); ?>"
	...
	<div class="sui-form-field">
		<label class="sui-label"><?php esc_html_e( 'Lead source', 'real-estate-leads-for-forminator' ); ?></label>
		<input name="source" value="<?php echo esc_attr( $ffub_vars['source'] ); ?>"
			placeholder="<?php esc_attr_e( 'Defaults to the form name', 'real-estate-leads-for-forminator' ); ?>" class="sui-form-control" />
	</div>

	<div class="sui-form-field">
		<label class="sui-label"><?php esc_html_e( 'System name', 'real-estate-leads-for-forminator' ); ?></label>
		<input name="system" value="<?php echo esc_attr( $ffub_vars['system'] ); ?>" class="sui-form-control" />
	</div>

	<div class="sui-form-field">
		<label class="sui-label"><?php esc_html_e( 'Event type', 'real-estate-leads-for-forminator' ); ?></label>
	...
	<div class="sui-form-field">
		<label class="sui-label"><?php esc_html_e( 'Tags', 'real-estate-leads-for-forminator' ); ?></label>
		<input name="tags" value="<?php echo esc_attr( $ffub_vars['tags'] ); ?>"
			placeholder="<?php esc_attr_e( 'Comma-separated, applied to every contact', 'real-estate-leads-for-forminator' ); ?>" class="sui-form-control" />
	</div>
</form>
